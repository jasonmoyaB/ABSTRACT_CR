        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaRegistro = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "sysutcdatetime()"),
                    RolID = table.Column<int>(type: "int", nullable: true),
                    Activo = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CorreoNorm = table.Column<string>(type: "nvarchar(450)", nullable: false, computedColumnSql: "lower(ltrim(rtrim([CorreoElectronico])))", stored: true)
                },
                constraints: table =>
                {
